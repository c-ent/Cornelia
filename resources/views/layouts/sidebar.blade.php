<ul class="list-unstyled mx-4" style="font-size:16px">
    ...
    <li>
        ...
        <ul class="list-unstyled mx-4" style="font-size:16px"> <!-- Nested list for Borrow History -->
            <li>
                <a href="{{ route('borrow.history') }}" class="d-flex align-items-center my-2">
                    <i class="bi bi-arrow-return-right mx-1" style="font-size: 24px";></i> Borrowing History
                </a>
            </li>
        </ul>
    </li>
