<ul class="list-unstyled mx-4" style="font-size:16px">
    <li>
        ...
        <a href="{{ route('superadmin.home') }}">Dashboard</a>
    </li>
    <li>
        ...
        <a class=""href="{{ route('books') }}">Books</a>
    </li>
    <li>
        ...
        <a href="{{ route('user.manage') }}">User Management</a>
    </li>
    <li>
        ...
        <a href="{{ route('book.manage') }}">Book Management</a>
    </li>
    <li>
        ...
        <a href="{{ route('bbh.manage') }}">Borrow History</a>
    </li>
    ...
    <div style="display:flex;position: absolute; margin-bottom:50px; bottom:0;">
        ...
        @auth
        <h3 class="mx-2">{{ auth()->user()->name }}</h3>
        @endauth
    </div>
